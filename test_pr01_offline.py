...
TABLES = {
    ...
    "nao_conformidades": [
        {
            "id": 1, "data": "2026-06-01", "status": "aguardando_feedback",
            "colaborador_id": "a", "colaborador": "Ana", "setor": "A",
            "criticidade": "Alta", "chamado": "1", "reincidencia": "Não",
            "aceito_em": None, "atualizado_em": None,
            "criado_em": "2026-06-01T00:00:00+00:00",
        },
        {
            "id": 2, "data": "2026-07-01", "status": "concluida",
            "colaborador_id": "b", "colaborador": "Bia", "setor": "B",
            "criticidade": "Baixa", "chamado": None, "reincidencia": "Sim",
            "aceito_em": "2026-07-05T00:00:00+00:00", "atualizado_em": None,
            "criado_em": "2026-07-01T00:00:00+00:00",
        },
        {
            "id": 3, "data": "2026-08-01", "status": "concluida",
            "colaborador_id": "c", "colaborador": "Carlos", "setor": "C",
            "criticidade": "Alta", "chamado": "3", "reincidencia": "Sim",
            "aceito_em": "2026-08-05T00:00:00+00:00", "atualizado_em": None,
    ...
    "medidas_disciplinares": [
        {"causa_id": 10, "colaborador_id": "a", "tipo": "advertencia", "data_aplicacao": "2026-06-10"},
        {"causa_id": 20, "colaborador_id": "c", "tipo": "suspensao", "data_aplicacao": "2026-08-10"},
    ],
}
...
assert resultado["escopo"] == {"tipo": "equipe_direta", "quantidade_colaboradores": 2}
assert resultado["kpis"]["total_ncs"] == 2, resultado["kpis"]
assert {x["colaborador"] for x in resultado["ncs_por_colaborador"]} == {"Ana", "Bia"}
...
resultado_adm = insights.obter_insights(adm, date(2026, 1, 1), date(2026, 12, 31))
